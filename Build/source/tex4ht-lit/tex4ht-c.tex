...
design_size_to_pt(
    (font_tbl[cur_fnt].wtbl && (`<chr width of`> >= 0) && (`<chr width of`> < font_tbl[cur_fnt].wtbl_n))?
        font_tbl[cur_fnt].wtbl[`<chr width of`>] : 0 )
            * (double) font_tbl[cur_fnt].scale
>>>


\<chr width of\><<<
( (font_tbl[cur_fnt].char_wi && (chr >= font_tbl[cur_fnt].char_f) && (chr <= font_tbl[cur_fnt].char_l - font_tbl[cur_fnt].char_f))?
    font_tbl[cur_fnt].char_wi[(chr - font_tbl[cur_fnt].char_f) % T1_NCHARS] : 0 )
>>>
...
\<(double) char_width( design_ch? design_ch : ch )\><<<
design_size_to_pt(
    (font_tbl[cur_fnt].wtbl && (`<design-ch / ch width of`> >= 0) && (`<design-ch / ch width of`> < font_tbl[cur_fnt].wtbl_n))?
        font_tbl[cur_fnt].wtbl[`<design-ch / ch width of`>] : 0 )
            * (double) font_tbl[cur_fnt].scale
>>>
...
\<(double) char_width( ch )\><<<
design_size_to_pt(
    (font_tbl[cur_fnt].wtbl && (`<ch of width`> >= 0) && (`<ch of width`> < font_tbl[cur_fnt].wtbl_n))?
        font_tbl[cur_fnt].wtbl[`<ch of width`>] : 0 )
            * (double) font_tbl[cur_fnt].scale
>>>
...
design_size_to_pt( (font_tbl[cur_fnt].htbl && (`<ch of height`> >= 0) && (`<ch of height`> < font_tbl[cur_fnt].htbl_n))?
    font_tbl[cur_fnt].htbl[`<ch of height`>] : 0 )
        * (double) font_tbl[cur_fnt].scale
>>>
...
design_size_to_pt( (font_tbl[cur_fnt].dtbl && (`<ch of depth`> >= 0) && (`<ch of depth`> < font_tbl[cur_fnt].dtbl_n))?
    font_tbl[cur_fnt].dtbl[`<ch of depth`>] : 0 )
        * (double) font_tbl[cur_fnt].scale
>>>
