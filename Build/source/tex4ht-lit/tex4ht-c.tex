...
\<initial values for new page\><<<
x_val = dx_1 = dx_2 = 0;  max_x_val = -10000 * 100 / x_fact; `%temp`%
...
{        long int  v;
   ...
   if( !text_on && (y_val > max_y_val) ){
     if( v > dy/2.5 ){
        `<cond insert new line`>  max_x_val = -10000 * 100 / x_fact;
...
( (font_tbl[cur_fnt].char_wi && (chr >= font_tbl[cur_fnt].char_f) && (chr <= font_tbl[cur_fnt].char_l - font_tbl[cur_fnt].char_f))?
    font_tbl[cur_fnt].char_wi[(chr - font_tbl[cur_fnt].char_f) % 256] : 0 )
>>>
